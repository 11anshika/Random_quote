const quotes = {
    ...
    "- Jawaharlal Nehru": '"At the dawn of history, India started on her unending quest, and trackless centuries are filled with her striving and the grandeur of her successes and her failures."',
    "- Dr. B.R. Ambedkar": '"Be educated, be organized, and be agitated."',
    "- Rabindranath Tagore": '"You can’t cross the sea merely by standing and staring at the water."',
    "- Sardar Vallabhbhai Patel": '"It is the habit of every aggressor nation to claim that it is acting on the defensive."',
    "- Indira Gandhi": '"You cannot shake hands with a clenched fist."',
    "- Kiran Bedi": '"The best way to find yourself is to lose yourself in the service of others."',
    ...
    "- Rani Lakshmibai": '"I shall not surrender. I will fight for my country till my last breath."',
    "- Sri Aurobindo": '"Life is a mystery; it is a gift that we must explore and understand."',
    "- Baba Amte": '"I would rather die than live a life without purpose."',
    "- C.V. Raman": '"The beauty and the mystery of the universe are enough to fill our hearts with wonder."',
    "- Mahatma Phule": '"Cultivation of the intellect is the greatest gift one can give to society."',
    ...
    "- Baba Ramdev": '"Your health is your true wealth."',
    "- Sarojini Naidu": '"We end today a period of ill fortune and India discovers herself again."',
